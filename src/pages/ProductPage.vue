<template>
  <div v-if="productLoading" style="display: flex; align-items: center; justify-content: center; flex-direction: column;">
    <h1>Загрузка товара...</h1>
    <img src="../loagingAnimation\827.svg" alt="Загрузка">
  </div>
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCard">
            ...
            <div v-show="productAddSending">
              <h3>Добавляем товар в корзину</h3>
              <img src="@/loagingAnimation/827.svg" alt="Загрузка">
            </div>
...
export default {
  ...
  // },
  watch: {
    '$route.params.id': { handler() { this.loadProduct() }, immediate: true } //тоже самое что и created
  }
}
</script>
